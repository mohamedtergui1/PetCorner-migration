...
class Thirdparties extends DolibarrApi
{
	...
	public function __construct()
	{
	 ...
	 public function getLogin($phone,$pwd)
	{
	
	$sql = "SELECT s.rowid  FROM ".MAIN_DB_PREFIX."societe_extrafields se ,".MAIN_DB_PREFIX."societe s WHERE s.rowid=se.fk_object and ";
//	s.phone='661112233' and se.mdpmob='12345678'";
	
	
	$sql .= " s.phone='".$phone."'";
	$sql .= " AND  se.mdpmob='".$pwd."'";
